...
### [⬇ Download CodeBridge for macOS](https://github.com/jobbsystemrapporter/codebridge/releases/download/v0.2.0-beta.4/CodeBridge-0.2.0-beta.4.dmg)

`v0.2.0-beta.4` · 90.4 MB · universal (Apple Silicon + Intel) · macOS 14 or newer · [how to install](#install)
