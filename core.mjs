...
export async function systemStatus(){const cfg=await getConfig();return {version:'0.2.0-beta.1',platform:process.platform,config:cfg,doctor:await doctor()}}
